...
<table width="627" border="1" align="center" cellspacing="0">
  <tr>
    <td height="23" colspan="10" align="center" class="titulos">
    <?php
		echo ("Aeroporto: ".$nome);
	?>
    </td>
  ...
  <tr>
    <td colspan="7" align="center" class="titulos">Auxílios</td>
...
<?php
  echo "<input type='radio' name='r_loc15' value='0' id='r_loc15_1' onChange='aviso_salvar();'";
    ...
    <td width="41">
        <label>
        <?php
        echo "<input name='r_loc15' type='radio' id='r_loc15_2' value='2' onChange='aviso_salvar();'";
        if ($loc15==2)
		{
	        echo("checked='checked'");
  ...
  <tr>
    ...
    <td><?php
		...
		?></td>
    <td><?php
        echo "<input name='r_gl15' type='radio' id='r_gl15_2' value='2' onChange='aviso_salvar();'";
		if ($gl15==2)
		{
	        echo("checked='checked'");
			$caminho = "imagens/indisponivel.png";
  ...
  <tr>
    ...
    <td><?php
		...
		?></td>
    <td><?php
        echo "<input name='r_loc33' type='radio' id='r_loc33_2' value='2' onChange='aviso_salvar();'";
		if ($loc33==2)
		{
	        echo("checked='checked'");
			$caminho = "imagens/indisponivel.png";
    ...
    <td colspan="2"><label for="t_visibilidade"></label>
      <input name="t_visibilidade" type="number" id="t_visibilidade" max="10000" step="100" onChange="testa();"
      <?php
  ...
  <tr>
    ...
    <td><?php
		...
		?></td>
    <td><?php
        echo "<input name='r_gl33' type='radio' id='r_gl33_2' value='2' onChange='aviso_salvar();'";
		if ($gl33==2)
		{
	        echo("checked='checked'");
			$caminho = "imagens/indisponivel.png";
  ...
  <tr>
    ...
    <td>
    <?php
    echo "<input type='radio' name='r_als15' value='2' id='r_als15_2' onChange='aviso_salvar();'";
		if ($als15==2)
		{
	        echo("checked='checked'");
			$caminho = "imagens/indisponivel.png";
    ...
    <td>&nbsp;</td>
    <td class="fonte">Sim</td>
    <td class="fonte">Não</td>
    </tr>
  <tr>
    ...
    <td><?php
		...
		?></td>
    <td><?php
        echo "<input name='r_flash15' type='radio' id='r_flash15_2' value='2' onChange='aviso_salvar();'";
		if ($flash15==2)
		{
	        echo("checked='checked'");
			$caminho = "imagens/indisponivel.png";
  ...
  <tr>
    ...
    <td><?php
		...
		?></td>
    <td><?php
        echo "<input name='r_thr15' type='radio' id='r_thr15_2' value='2' onChange='aviso_salvar();'";
  ...
  <tr>
    ...
    <td><?php
		...
		?></td>
    <td><?php
        echo "<input name='r_tdz15' type='radio' id='r_tdz15_2' value='2' onChange='aviso_salvar();'";
		if ($tdz15==2)
		{
	        echo("checked='checked'");
			$caminho = "imagens/indisponivel.png";
  ...
  <tr>
    ...
    <td><?php
		...
		?></td>
    <td><?php
        echo "<input name='r_rcl' type='radio' id='r_rcl_2' value='2' onChange='aviso_salvar();'";
		if ($rcl==2)
		{
	        echo("checked='checked'");
			$caminho = "imagens/indisponivel.png";
  ...
  <tr>
    ...
    <td><?php
		...
		?></td>
    <td><?php
        echo "<input name='r_blz1533' type='radio' id='r_blz1533_2' value='2' onChange='aviso_salvar();'";
		if ($blz1533==2)
		{
	        echo("checked='checked'");
			$caminho = "imagens/indisponivel.png";
  ...
  <tr>
    ...
    <td><?php
		...
		?></td>
    <td><?php
        echo "<input name='r_blz1129' type='radio' id='r_blz1129_2' value='2' onChange='aviso_salvar();'";
		if ($blz1129==2)
		{
	        echo("checked='checked'");
			$caminho = "imagens/indisponivel.png";
  ...
  <tr>
    ...
    <td><?php
		...
		?></td>
    <td><?php
        echo "<input name='r_blztwy' type='radio' id='r_blztwy_2' value='2' onChange='aviso_salvar();'";
		if ($blztwy==2)
		{
	        echo("checked='checked'");
			$caminho = "imagens/indisponivel.png";
...
";        
		...
		?></td>
    <td><?php
        echo "<input name='r_om15' type='radio' id='r_om15_2' value='2' onChange='aviso_salvar();'
";        
		if ($om15==2)
		{
	        echo("checked='checked'");
  ...
  <tr>
    ...
    <td><?php
		...
		?></td>
    <td><?php
        echo "<input name='r_mm15' type='radio' id='r_mm15_2' value='2' onChange='aviso_salvar();'";
		if ($mm15==2)
		{
	        echo("checked='checked'");
			$caminho = "imagens/indisponivel.png";
...
";        
		...
		?></td>
    <td><?php
        echo "<input name='r_im15' type='radio' id='r_im15_2' value='2' onChange='aviso_salvar();'
";        
		if ($im15==2)
		{
	        echo("checked='checked'");
  ...
  <tr>
    ...
    <td><?php
		...
		?></td>
    <td><?php
        echo "<input name='r_om33' type='radio' id='r_om33_2' value='2' onChange='aviso_salvar();'";
		if ($om33==2)
		{
	        echo("checked='checked'");
			$caminho = "imagens/indisponivel.png";
  ...
  <tr>
    ...
    <td><?php
		...
		?></td>
    <td><?php
        echo "<input name='r_mm33' type='radio' id='r_mm33_2' value='2' onChange='aviso_salvar();'";
		if ($mm33==2)
		{
	        echo("checked='checked'");
			$caminho = "imagens/indisponivel.png";
  ...
  <tr>
    ...
    <td><?php
		...
		?></td>
    <td><?php
        echo "<input name='r_im33' type='radio' id='r_im33_2' value='2' onChange='aviso_salvar();'";
		if ($im33==2)
		{
	        echo("checked='checked'");
			$caminho = "imagens/indisponivel.png";
  ...
  <tr>
    ...
    <td><?php
		...
		?></td>
    <td><?php
        echo "<input name='r_vor' type='radio' id='r_vor_2' value='2' onChange='aviso_salvar();'";
		if ($vor==2)
		{
	        echo("checked='checked'");
			$caminho = "imagens/indisponivel.png";
  ...
  <tr>
    ...
    <td><?php
		...
		?></td>
    <td><?php
        echo "<input name='r_dme' type='radio' id='r_dme_2' value='2' onChange='aviso_salvar();'";
		if ($dme==2)
		{
	        echo("checked='checked'");
			$caminho = "imagens/indisponivel.png";
  ...
  <tr>
    ...
    <td><?php
		...
		?></td>
    <td><?php
        echo "<input name='r_rvr15' type='radio' id='r_rvr15_2' value='2' onChange='aviso_salvar();'";
		if ($rvr15==2)
		{
	        echo("checked='checked'");
			$caminho = "imagens/indisponivel.png";
  ...
  <tr>
    ...
    <td><?php
		...
		?></td>
    <td><?php
        echo "<input name='r_rvrmedio' type='radio' id='r_rvrmedio_2' value='2' onChange='aviso_salvar();'";
		if ($rvrmedio==2)
		{
	        echo("checked='checked'");
			$caminho = "imagens/indisponivel.png";
  ...
  <tr>
    ...
    <td><?php
		...
		?></td>
    <td><?php
        echo "<input name='r_rvr33' type='radio' id='r_rvr33_2' value='2' onChange='aviso_salvar();'";
		if ($rvr33==2)
		{
	        echo("checked='checked'");
			$caminho = "imagens/indisponivel.png";
  ...
  <tr>
    ...
    <td><?php
		...
		?></td>
    <td><?php
        echo "<input name='r_radar' type='radio' id='r_radar_2' value='2' onChange='aviso_salvar();'";
		if ($radar==2)
		{
	        echo("checked='checked'");
			$caminho = "imagens/indisponivel.png";
...
<?php
  ...
  <tr>
    <td colspan="5" align="center"><div class="vermelho" id="aviso"></div><input type="submit" name="atualizar" id="atualizar" value="Atualizar"></td>
    </tr>
</table>
<br/>
<br/>
...
<table width="604" border="1" cellspacing="0" align="center">
  <tr>
